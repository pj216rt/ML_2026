...
\begin{itemize}
    ...
    \]
    For each of the three datasets, we do the same thing.  We first find a learning rate \(\eta\) that permit
    the loss to converge in at most 200 iterations.  We loop over a grid to find the best \(\eta\) (in terms 
