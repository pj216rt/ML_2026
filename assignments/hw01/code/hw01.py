...
train_data = pd.read_csv("assignments/hw01/data/X.dat", delim_whitespace=True, header=None)
train_labels = pd.read_csv("assignments/hw01/data/Y.dat", header=None)

validate_data = pd.read_csv("assignments/hw01/data/Xtest.dat", delim_whitespace=True, header=None)
validate_labels = pd.read_csv("assignments/hw01/data/Ytest.dat", header=None)
